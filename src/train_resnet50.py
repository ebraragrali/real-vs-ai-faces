...
class CFG:
    ...
    # "daha fazla epoch olabilir ama uzun sürmesin"
    max_epochs: int = 20
    patience: int = 3
    ...
    run_dir: str = "runs/resnet50_run1"
...
def main():
    ...
    # Transforms (ResNet ImageNet normalize)
    ...
    optimizer = Adam(model.fc.parameters(), lr=cfg.lr, weight_decay=cfg.weight_decay)
    ...
    print("Loaded best checkpoint epoch:", ckpt["epoch"])
